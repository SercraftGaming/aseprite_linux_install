...
mkdir /tmp/aseprite-install
cd /tmp/aseprite-install
...
cmake \
  ...
  -DLAF_BACKEND=skia \
  -DSKIA_DIR=/tmp/aseprite-install/deps/skia \
  -DSKIA_LIBRARY_DIR=/tmp/aseprite-install/deps/skia/out/Release-x64 \
  -DSKIA_LIBRARY=/tmp/aseprite-install/deps/skia/out/Release-x64/libskia.a \
  -G Ninja \
  ..
ninja aseprite
...
Exec=/home/$USER/Applications/aseprite/aseprite
Icon=/home/$USER/Applications/aseprite/data/icons/ase64.png
